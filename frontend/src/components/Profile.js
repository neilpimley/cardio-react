...
import profileScrubsBw from '../images/profile-scrubs-bw.jpg';
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-xs-12 col-md-5">
                    <img src={profileScrubsBw} className="img-fluid img-thumbnail float-left" alt="Dr. Peter McKavanagh" />
                </div>
            ...
            <div className="row">
                <div className="col-lg-12 mx-auto text-white">
                    ...
                    <p>All three of his degrees were from Queen's University Belfast. His primary medical degree with distinction
                        was in 2003; his MSc in Clinical Education with distinction was in 2010; and his PhD in Cardiac
                    ...
                    <p>His general cardiology training was in Belfast and he completed the membership examinations for the Royal
                        College of Physicians for both the UK and Ireland. Peter then had a two-year fellowship at a large cardiology 
                        centre in Toronto receiving recognition for this from the University of Toronto. He also has an interest in third world 
                        cardiology, having spent 6 months volunteering in Kenya in a large cardiology centre in Nairobi, as well as being
                    ...
                    <p>Peter has always had a keen interest in sport, and continues to train regularly. He was captain of the
                        ...
                        senior levels. He has also volunteered with vulnerable adults and continues to offer cardiology support for the Belfast Trust 
                        homeless service.</p>

                    <p>Peter returned to Northern Ireland in 2017 and has been working between the Ulster and Royal Victoria Hospitals since. He has regular 
                        cardiology clinics and is happy to see all adult cardiac vascular disease complaints.</p>
                </div>
            </div>
        </div>
        </section>
